...
namespace Bookstore.DAL.Migrations
{
    ...
    [Migration("20200117122501_AddImageAndCategoryProperty")]
    partial class AddImageAndCategoryProperty
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Bookstore.DAL.Models.BookDimension", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Bookstore.DAL.Models.BookDimension", b =>
                {
                    b.HasOne("Bookstore.DAL.Models.BookDetail", "BookDetails")
                        .WithOne("Dimensions")
                        .HasForeignKey("Bookstore.DAL.Models.BookDimension", "BookDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
